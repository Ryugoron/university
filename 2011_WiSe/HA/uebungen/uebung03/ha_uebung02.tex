...
\item FEHLER!! MASTER THEOREM GEHT NICHT \\ $T(n) = 7 T(\frac{n}{3}) + n^2$\\
$a= 7, \; b = 3, \; f(n) = n^2$
Nun gilt:
$$
n^2 = \Omega (n^{2 - 0.1}) = \Omega(n^{\log_3 7}) \quad , \text{ wobei wir }\varepsilon =  0.1 \text{ wählen}
$$
und
$$
a \cdot f(\frac{n}{b}) = 7 \cdot \frac{n^2}{9} \leq \frac{7}{9} n^2
$$
Damit können wir das Mastertheorem anwenden.
$$
