...
$\Rightarrow$ Innerhalb der Intervalle fällt die Funktion und die obere grenze pro Interval fällt streng monoton. Dies ist nach Analysis ein Konvergenzkriterium. Da wir nicht zeigen müssen, dass es nicht $\Theta$ ist, hören wir an dieser Stelle auf und zeigen nicht, dass es wirklich gegen 0 konvergiert.\\
