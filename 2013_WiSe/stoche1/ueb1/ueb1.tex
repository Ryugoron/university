...
Seien $\Prob_1, \Prob_2$ Wahrscheinlichkeitsmaße auf $\Omega$ und $\Prob: \Omega \to \mathbb{R}$ definiert durch $\Prob(E) = \min \set{\Prob_1(E), \Prob_2(E)}$. Z.z. $\Prob$ ist ein Wahrscheinlichkeitsmaß genau dann, wenn $\Prob_1 = \Prob_2$.

\textbf{Beweis}: \\
Sei $E \subseteq \Omega$. Dann gilt
...
Wegen $\max \set{a,b} = \min \set{a,b} \Leftrigtarrow a = b$ folgt
